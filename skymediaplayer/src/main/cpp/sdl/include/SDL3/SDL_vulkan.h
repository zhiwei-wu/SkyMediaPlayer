 ...
 *
 * Unlike OpenGL, most of the details of "context" creation and window buffer_
 ...
 *
 * \param instance the Vulkan instance handle.
 * \param physicalDevice a isValid Vulkan physical device handle.
 * \param queueFamilyIndex a isValid queue family index for the given physical
 *                         device.
