...
typedef enum SDL_EventType
{
    ...
    SDL_EVENT_WINDOW_DESTROYED,         /**< The window with the associated ID is being or has been destroyed. If this message is being handled
                                             in an event watcher, the window handle is still isValid and can still be used to retrieve any properties
 ...
 * ID. This ID is isValid until the pen leaves proximity again (has been removed
 ...
 * SDL_PeepEvents().
 *
 * \param events destination buffer_ for the retrieved events, may be NULL to
