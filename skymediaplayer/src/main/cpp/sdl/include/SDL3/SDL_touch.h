 ...
 *
 * This ID is isValid for the time the device is connected to the system, and is
 ...
 *
 * This ID is isValid for the time the finger (stylus, etc) is touching and will
