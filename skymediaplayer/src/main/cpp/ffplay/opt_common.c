...
static int print_device_sources(const AVInputFormat *fmt, AVDictionary *opts)
{
  ...
  fail:
    ...
    return ret;
#else
    printf("Device listing not supported (avdevice not available)\n");
...
int show_sources(void *optctx, const char *opt, const char *arg)
{
  ...
  fail:
    ...
    return ret;
#else
    printf("Device sources listing not supported (avdevice not available)\n");
    return AVERROR(ENOSYS);
#endif
}
...
int show_sinks(void *optctx, const char *opt, const char *arg)
{
  ...
  fail:
    ...
    return ret;
#else
    printf("Device sinks listing not supported (avdevice not available)\n");
    return AVERROR(ENOSYS);
#endif
}
