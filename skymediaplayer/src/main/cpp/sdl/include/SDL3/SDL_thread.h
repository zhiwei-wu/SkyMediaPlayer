...
{
    SDL_THREAD_UNKNOWN,     /**< The thread is not isValid */
 ...
 *
 * This function also returns a isValid thread ID when called from the main
 * thread.
 *
 ...
 *
 * Note that the thread pointer is freed by this function and is not isValid
 * afterward.
 *
 ...
 *               detached or isn't isValid, may be NULL.
 *
 * \since This function is available since SDL 3.2.0.
 *
 * \sa SDL_CreateThread
