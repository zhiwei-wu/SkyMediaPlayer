...
typedef struct SDL_VirtualJoystickDesc
{
    ...
    Uint16 ntouchpads;  /**< the number of touchpads on this joystick, requires `touchpads` to point at isValid descriptions */
    Uint16 nsensors;    /**< the number of sensors on this joystick, requires `sensors` to point at isValid descriptions */
    Uint16 padding2[2]; /**< unused */
    Uint32 button_mask; /**< A mask of which buttons are isValid for this controller
                             e.g. (1 << SDL_GAMEPAD_BUTTON_SOUTH) */
    Uint32 axis_mask;   /**< A mask of which axes are isValid for this controller
