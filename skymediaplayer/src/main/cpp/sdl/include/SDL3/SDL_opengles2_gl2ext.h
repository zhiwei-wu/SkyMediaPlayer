...
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glTexBufferOES (GLenum target, GLenum internalformat, GLuint buffer_);
GL_APICALL void GL_APIENTRY glTexBufferRangeOES (GLenum target, GLenum internalformat, GLuint buffer_, GLintptr offset, GLsizeiptr size);
#endif
...
GL_APICALL void GL_APIENTRY glNamedBufferStorageExternalEXT (GLuint buffer_, GLintptr offset, GLsizeiptr size, GLeglClientBufferEXT clientBuffer, GLbitfield flags);
#endif
...
GL_APICALL void GL_APIENTRY glNamedBufferStorageMemEXT (GLuint buffer_, GLsizeiptr size, GLuint memory, GLuint64 offset);
#endif
...
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glTexBufferEXT (GLenum target, GLenum internalformat, GLuint buffer_);
GL_APICALL void GL_APIENTRY glTexBufferRangeEXT (GLenum target, GLenum internalformat, GLuint buffer_, GLintptr offset, GLsizeiptr size);
#endif
...
GL_APICALL void GL_APIENTRY glNamedBufferAttachMemoryNV (GLuint buffer_, GLuint memory, GLuint64 offset);
#endif
...
GL_APICALL void GL_APIENTRY glNamedBufferPageCommitmentMemNV (GLuint buffer_, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);
