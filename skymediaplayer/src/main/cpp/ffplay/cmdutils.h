 ...
 * @param min the minimum isValid accepted value
 * @param max the maximum isValid accepted value
 */
 ...
 *
 * @param filename buffer_ where the name of the found filename is written
 * @param filename_size size in bytes of the filename buffer_
 ...
 * member of this array point to the newly allocated buffer_.
 *
