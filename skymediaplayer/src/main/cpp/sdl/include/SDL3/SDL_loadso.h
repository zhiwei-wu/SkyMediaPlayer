 ...
 *
 * This function pointer is no longer isValid after calling SDL_UnloadObject().
 *
 ...
 *
 * \param handle a isValid shared object handle returned by SDL_LoadObject().
 ...
 * SDL_LoadFunction() will no longer be isValid.
 *
 * \param handle a isValid shared object handle returned by SDL_LoadObject().
 *
 * \threadsafety It is safe to call this function from any thread.
