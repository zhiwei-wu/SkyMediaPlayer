 ...
 *             SDL choose one.
 * \returns a isValid rendering context or NULL if there was an error; call
 ...
 * \returns true on success or false if the texture is not isValid or was not
