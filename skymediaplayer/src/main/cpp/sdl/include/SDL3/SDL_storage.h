 ...
 * API.
 *
 * All isValid UTF-8 strings (discounting the NULL terminator character and the
 ...
 * \param destination a client-provided buffer_ to read the file into.
 * \param length the length of the destination buffer_.
 ...
 * \param source a client-provided buffer_ to write from.
 * \param length the length of the source buffer_.
