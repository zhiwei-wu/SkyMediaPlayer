 ...
 *
 * \param buffer_ Buffer in which to generate the random seed. Must have a capacity of at least length + 1 characters.
 * \param length Number of alphanumeric characters to write to buffer_, must be >0
 *
 * \returns A null-terminated seed string and equal to the in put buffer_ on success, NULL on failure
 */
