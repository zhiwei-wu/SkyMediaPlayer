 ...
 * is true, the function will only return isValid boundaries, otherwise non-valid
 ...
 * \param validDomain Should the generated boundary be isValid (=within the bounds) or not?
 *
 ...
 * Boundaries are inclusive, see the usage examples below. If validDomain
 * is true, the function will only return valid boundaries, otherwise non-isValid
 * boundaries are also possible.
 * If boundary1 > boundary2, the values are swapped
 *
 * Usage examples:
